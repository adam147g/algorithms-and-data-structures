...
'''
Przechodzenie po grafie, uswanie po jednym wierzchołku i zliczanie na ile spójnych
podgrafów rozpadnie się nasz graf
- components - zliczanie na ile się rozpadnie
'''
