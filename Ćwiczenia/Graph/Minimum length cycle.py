# Dany jest graf nieskierowany reprezentowany przez macierz sąsiedztwa G,
...
# go krawędzi. Jeśli cyklu nie ma, funkcja powinna zwrócić pustą listę.
# Jeśli cykl istnieje, to funkcja powinna zwrócić listę wierzchołków,
